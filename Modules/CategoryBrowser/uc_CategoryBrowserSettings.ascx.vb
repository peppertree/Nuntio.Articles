...
Namespace dnnWerk.Modules.Nuntio.Articles
    Partial Public Class uc_CategoryBrowserSettings
...
#Region "Private Methods"
        ...
        Private Sub SaveSettings()
            ...
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "ModuleView", "CategoryBrowser")
...
#Region "Event Handlers"
        ...
        Public Overrides Sub LoadForm()
            ...
            Else
                Me.Controls.Clear()
                Me.Controls.Add(New LiteralControl("<div style=""margin:20px;padding:20px;border:1px dashed #ccc;background:yellow;font-weight:bold;"">In order to work with the Category Browser, you first have to create an article listing somewhere in your portal to connect to.</div>"))
            End If
