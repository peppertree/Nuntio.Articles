<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_CategoryBrowserSettings.ascx.vb" Inherits="dnnWerk.Modules.Nuntio.Articles.uc_CategoryBrowserSettings" %>
