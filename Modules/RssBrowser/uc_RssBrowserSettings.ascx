<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_RssBrowserSettings.ascx.vb" Inherits="dnnWerk.Modules.Nuntio.Articles.uc_RssBrowserSettings" %>
...
<table cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td class="SubHead" valign="top" style="width:225px;height:60px;"><dnn:label id="plSkin" suffix=":" controlname="drpSkin" runat="server"></dnn:label></td>
		<td valign="top">
	...
	<tr>
		<td class="SubHead" valign="top" style="width:225px;height:60px;"><dnn:label id="plModuletitle" suffix=":" runat="server"></dnn:label></td>
		<td valign="top">
