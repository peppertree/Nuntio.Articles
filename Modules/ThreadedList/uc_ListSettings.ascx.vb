...
Namespace dnnWerk.Modules.Nuntio.Articles
    Partial Public Class uc_ThreadedSettings
...
#Region "Private Methods"
        ...
        Private Sub LoadSettings(ByVal RebindModule As Boolean)
            ...
            drpWelcomeArticle.Items.Clear()

            If WelcomeArticleId <> Null.NullInteger Then
                Dim ctrl As New ArticleController
                Dim objWelcome As ArticleInfo = ctrl.GetArticle(WelcomeArticleId, CurrentLocale, True)
                If Not objWelcome Is Nothing Then
                    drpWelcomeArticle.Items.Add(New RadComboBoxItem(objWelcome.Title, objWelcome.ItemId.ToString))
                End If
            End If
            ...
            'cboModules.ClearSelection()
            'drpThemes.ClearSelection()
            ...
            Else
                ...
                If Me.IsModerated Then
                    ...
                    Me.drpModeratorRole.SelectedValue = ModeratorRole
            ...
            Me.txtContentWidth.Text = Me.ContentWidth
            Me.txtTocWidth.Text = Me.TocWidth
            Me.txtSplitterHeight.Text = Me.SplitterHeight
            Me.txtSplitterWidth.Text = Me.SplitterWidth
        ...
        Private Sub SaveSettings()
            ...
            If Not String.IsNullOrEmpty(drpWelcomeArticle.SelectedValue) Then
                modulecontrol.UpdateModuleSetting(Me.ModuleId, "WelcomeArticleId", drpWelcomeArticle.SelectedValue)
            Else
                modulecontrol.DeleteModuleSetting(Me.ModuleId, "WelcomeArticleId")
            End If
            ...
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "ModuleView", "ThreadedList")
            ...
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "SplitterWidth", txtSplitterWidth.Text)
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "SplitterHeight", txtSplitterHeight.Text)
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "TocWidth", txtTocWidth.Text)
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "ContentWidth", txtContentWidth.Text)
...
#Region "Event Handlers"
        ...
        'Private Sub chkShowForeign_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles chkShowForeign.CheckedChanged
        '    If Me.chkShowForeign.Checked Then

        '        Me.rowForeignModule.Visible = True

        '        BindTabs()
        '        If cboTabs.SelectedIndex > 0 Then
        '            Me.cboModules.Visible = True
        '            BindModules()
        '        Else
        ...
        '        Me.rowAllowSubscriptions.Visible = False
        '        Me.rowOnlyRegisteredUsers.Visible = False
        '        Me.rowShowRegister.Visible = False
        '        Me.rowNotifyAdmin.Visible = False
        '        Me.rowFromAddress.Visible = False
        '        Me.rowRoles.Visible = False
        '        Me.rowEnableSummary.Visible = False
        '        Me.rowModerate.Visible = False


        '        Me.rowCategories.Visible = True
        '        BindCategories()
        ...
        '        Me.rowForeignModule.Visible = False
        '        Me.rowAllowSubscriptions.Visible = True
        '        Me.rowNotifyAdmin.Visible = Me.chkAllowSubscriptions.Checked
        '        Me.rowShowRegister.Visible = Me.chkAllowSubscriptions.Checked
        '        Me.rowOnlyRegisteredUsers.Visible = Me.chkAllowSubscriptions.Checked
        '        Me.rowRoles.Visible = True
        '        Me.rowFromAddress.Visible = True
        '        Me.rowEnableSummary.Visible = True
        '        Me.rowModerate.Visible = True



        '        Me.rowCategories.Visible = False
        ...
        Private Sub drpWelcomeArticle_ItemsRequested(ByVal sender As Object, ByVal e As Telerik.Web.UI.RadComboBoxItemsRequestedEventArgs) Handles drpWelcomeArticle.ItemsRequested

            Dim combo As RadComboBox = CType(sender, RadComboBox)
            combo.Items.Clear()

            Dim qualifier As String = DotNetNuke.Data.DataProvider.Instance().ObjectQualifier

            Dim sql As String = "Select * from " & DotNetNuke.Data.DataProvider.Instance().ObjectQualifier & "pnc_Localization_LocalizedItems where ModuleId = " & ModuleId.ToString & " and Content Like '%" & e.Text & "%' and [Key] = 'TITLE' and IsApproved = 1"
