<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_ListSettings.ascx.vb" Inherits="dnnWerk.Modules.Nuntio.Articles.uc_ListSettings" %>
...
<table cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td class="SubHead" valign="top" style=";"><dnn:label id="plModuletitle" suffix=":" runat="server"></dnn:label></td>
