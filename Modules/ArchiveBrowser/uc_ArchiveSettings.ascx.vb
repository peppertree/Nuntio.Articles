...
#Region "Private Methods"
        ...
        Private Sub LoadSettings()
            ...
            Try
                ...
                modulecontrol.DeleteTabModuleSetting(Me.TabModuleId, "IncludeMonth")
            ...
            Try
                ...
                Me.chkIncludeMonth.Checked = Me.IncludeMonth
        ...
        Private Sub SaveSettings()
            ...
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "ModuleView", "ArchiveBrowser")
            ...
            modulecontrol.UpdateModuleSetting(Me.ModuleId, "IncludeMonth", Me.chkIncludeMonth.Checked)
...
#Region "Event Handlers"
        ...
        Public Overrides Sub LoadForm()
            ...
            Else
                Me.Controls.Clear()
                Me.Controls.Add(New LiteralControl("<div style=""margin:20px;padding:20px;border:1px dashed #ccc;background:yellow;font-weight:bold;"">In order to work with the Archive Browser, you first have to create an article listing somewhere in your portal to connect to.</div>"))
            End If
