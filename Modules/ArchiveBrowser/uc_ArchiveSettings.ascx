<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="uc_ArchiveSettings.ascx.vb" Inherits="dnnWerk.Modules.Nuntio.Articles.uc_ArchiveSettings" %>
...
<table cellspacing="0" cellpadding="0" border="0">
	...
	<tr>
		<td class="SubHead" valign="top" style="width:225px;height:35px;"><dnn:label id="plIncludeMonth" suffix=":" controlname="drpSkin" runat="server"></dnn:label></td>
		<td valign="top">
            <asp:CheckBox ID="chkIncludeMonth" runat="server" />		
		</td>
	</tr>
	<tr>
